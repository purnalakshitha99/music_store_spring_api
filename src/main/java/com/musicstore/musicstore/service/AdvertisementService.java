...
public interface AdvertisementService  {
    ...
    AdvertisementResponse createAdvertisement(AdvertisementRq advertisementRq, Long userId, MultipartFile file)throws AdvertisementNotFoundException, UserNotFoundException;
}
